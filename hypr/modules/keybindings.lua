...
local reload = "$HOME/.config/hypr/scripts/reload.sh"
local wallpaperSwitcher = "$HOME/.config/rofi/wallselect/script.sh"
...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd(screenShot))
